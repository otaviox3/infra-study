...
sudo clear
echo "==========================================="
echo " Instalação PHP 7.4 com OCI8 + PDO OCI + Apache"
echo "           Ubuntu 24.0x e acima"
echo "==========================================="
echo ""
...
echo "==========================================="
run_noninteractive add-apt-repository -y ppa:ondrej/php
run_noninteractive apt-get update -y
...
echo "==========================================="
run_noninteractive apt-get install -y unzip php7.4 php7.4-dev build-essential libaio1t64 \
